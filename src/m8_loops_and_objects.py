...
def draw_circles1():
    ...
    count = 0
    for k in range(21):
        circle = rg.Circle(rg.Point(200, 200), count)
...
def draw_circles2():
    ...
    count = 50
    for k in range(18):
        circle = rg.Circle(rg.Point(count, 100), 10)
...
def draw_circles3():
    ...
    for k in range(21):
        count = count + 1
        circle = rg.Circle(rg.Point(200, 150), count)
        circle.attach_to(window)
        window.render()
...
def draw_cosines_and_sines():
    ...
    for k in range(101):
        total = 80 * math.cos(count)
        total2 = 80 * math.sin(count)
        circle = rg.Circle(rg.Point(200+total, 200+total2), 10)
        count = count + 1
        circle.attach_to(window)
        window.render()
